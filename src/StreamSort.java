...
*/
        ...
        List<Product> compareSort1 = productsList.stream()
                .sorted(Comparator.comparing(Product::getName).thenComparing(Product::getPrice))
                .collect(Collectors.toList());
        System.out.println("compare sort1 :" + compareSort1);

        List<Product> compareSort = productsList.stream()
                .sorted(Comparator.comparing(Product::getPrice)
                        .thenComparing(Product::getName)
                        //.reversed()
                )
                .collect(Collectors.toList());
        System.out.println("compare sort :" + compareSort);
    }
}
